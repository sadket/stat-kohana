...
2013-05-15 09:53:55 --- EMERGENCY: ErrorException [ 1 ]: Call to private method Model_Order::get_rows() from context 'Controller_Index' ~ APPPATH/classes/Controller/Index.php [ 42 ] in :
2013-05-15 09:53:55 --- DEBUG: #0 [internal function]: Kohana_Core::shutdown_handler()
#1 {main} in :
2013-05-15 10:05:03 --- EMERGENCY: ErrorException [ 1 ]: Call to undefined method Model_Orderuser::to_array() ~ APPPATH/classes/Model/Order.php [ 30 ] in :
2013-05-15 10:05:03 --- DEBUG: #0 [internal function]: Kohana_Core::shutdown_handler()
#1 {main} in :
2013-05-15 10:15:47 --- EMERGENCY: ErrorException [ 8 ]: Trying to get property of non-object ~ APPPATH/classes/Model/Order.php [ 30 ] in /home/www/kohana/application/classes/Model/Order.php:30
2013-05-15 10:15:47 --- DEBUG: #0 /home/www/kohana/application/classes/Model/Order.php(30): Kohana_Core::error_handler(8, 'Trying to get p...', '/home/www/kohan...', 30, Array)
#1 /home/www/kohana/application/classes/Controller/Index.php(42): Model_Order->get_results('4')
#2 /home/www/kohana/system/classes/Kohana/Controller.php(84): Controller_Index->action_results()
#3 [internal function]: Kohana_Controller->execute()
#4 /home/www/kohana/system/classes/Kohana/Request/Client/Internal.php(97): ReflectionMethod->invoke(Object(Controller_Index))
#5 /home/www/kohana/system/classes/Kohana/Request/Client.php(114): Kohana_Request_Client_Internal->execute_request(Object(Request), Object(Response))
#6 /home/www/kohana/system/classes/Kohana/Request.php(990): Kohana_Request_Client->execute(Object(Request))
#7 /home/www/kohana/index.php(118): Kohana_Request->execute()
#8 {main} in /home/www/kohana/application/classes/Model/Order.php:30
2013-05-15 10:20:54 --- EMERGENCY: Database_Exception [ 1064 ]: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '' at line 1 [ SELECT `order`.`id` AS `id`, `order`.`site_id` AS `site_id`, `order`.`type` AS `type`, `order`.`content` AS `content`, `order`.`user_id` AS `user_id`, `order`.`date` AS `date`, `order`.`user_ref` AS `user_ref`, `order`.`enter_page` AS `enter_page`, `order`.`send_page` AS `send_page`, `order`.`engine` AS `engine`, `order`.`utm_type` AS `utm_type`, `order`.`adv_comp` AS `adv_comp`, `order`.`keywords` AS `keywords`, `order`.`webvisor_link` AS `webvisor_link`, `order`.`add_info` AS `add_info` FROM `orders` AS `order` WHERE `site_id` = '4' ORDER BY `id` = ] ~ MODPATH/database/classes/Kohana/Database/MySQL.php [ 194 ] in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:20:54 --- DEBUG: #0 /home/www/kohana/modules/database/classes/Kohana/Database/Query.php(251): Kohana_Database_MySQL->query(1, 'SELECT `order`....', 'Model_Order', Array)
...
#3 /home/www/kohana/application/classes/Model/Order.php(19): Kohana_ORM->find_all()
#4 /home/www/kohana/application/classes/Model/Order.php(28): Model_Order->get_rows('4')
#5 /home/www/kohana/application/classes/Controller/Index.php(42): Model_Order->get_results('4')
#6 /home/www/kohana/system/classes/Kohana/Controller.php(84): Controller_Index->action_results()
#7 [internal function]: Kohana_Controller->execute()
#8 /home/www/kohana/system/classes/Kohana/Request/Client/Internal.php(97): ReflectionMethod->invoke(Object(Controller_Index))
#9 /home/www/kohana/system/classes/Kohana/Request/Client.php(114): Kohana_Request_Client_Internal->execute_request(Object(Request), Object(Response))
...
#11 /home/www/kohana/index.php(118): Kohana_Request->execute()
#12 {main} in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:20:57 --- EMERGENCY: Database_Exception [ 1064 ]: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '' at line 1 [ SELECT `order`.`id` AS `id`, `order`.`site_id` AS `site_id`, `order`.`type` AS `type`, `order`.`content` AS `content`, `order`.`user_id` AS `user_id`, `order`.`date` AS `date`, `order`.`user_ref` AS `user_ref`, `order`.`enter_page` AS `enter_page`, `order`.`send_page` AS `send_page`, `order`.`engine` AS `engine`, `order`.`utm_type` AS `utm_type`, `order`.`adv_comp` AS `adv_comp`, `order`.`keywords` AS `keywords`, `order`.`webvisor_link` AS `webvisor_link`, `order`.`add_info` AS `add_info` FROM `orders` AS `order` WHERE `site_id` = '4' ORDER BY `id` = ] ~ MODPATH/database/classes/Kohana/Database/MySQL.php [ 194 ] in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:20:57 --- DEBUG: #0 /home/www/kohana/modules/database/classes/Kohana/Database/Query.php(251): Kohana_Database_MySQL->query(1, 'SELECT `order`....', 'Model_Order', Array)
#1 /home/www/kohana/modules/orm/classes/Kohana/ORM.php(1060): Kohana_Database_Query->execute(Object(Database_MySQL))
#2 /home/www/kohana/modules/orm/classes/Kohana/ORM.php(1001): Kohana_ORM->_load_result(true)
#3 /home/www/kohana/application/classes/Model/Order.php(19): Kohana_ORM->find_all()
#4 /home/www/kohana/application/classes/Model/Order.php(28): Model_Order->get_rows('4')
...
#11 /home/www/kohana/index.php(118): Kohana_Request->execute()
#12 {main} in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:20:58 --- EMERGENCY: Database_Exception [ 1064 ]: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '' at line 1 [ SELECT `order`.`id` AS `id`, `order`.`site_id` AS `site_id`, `order`.`type` AS `type`, `order`.`content` AS `content`, `order`.`user_id` AS `user_id`, `order`.`date` AS `date`, `order`.`user_ref` AS `user_ref`, `order`.`enter_page` AS `enter_page`, `order`.`send_page` AS `send_page`, `order`.`engine` AS `engine`, `order`.`utm_type` AS `utm_type`, `order`.`adv_comp` AS `adv_comp`, `order`.`keywords` AS `keywords`, `order`.`webvisor_link` AS `webvisor_link`, `order`.`add_info` AS `add_info` FROM `orders` AS `order` WHERE `site_id` = '4' ORDER BY `id` = ] ~ MODPATH/database/classes/Kohana/Database/MySQL.php [ 194 ] in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:20:58 --- DEBUG: #0 /home/www/kohana/modules/database/classes/Kohana/Database/Query.php(251): Kohana_Database_MySQL->query(1, 'SELECT `order`....', 'Model_Order', Array)
#1 /home/www/kohana/modules/orm/classes/Kohana/ORM.php(1060): Kohana_Database_Query->execute(Object(Database_MySQL))
#2 /home/www/kohana/modules/orm/classes/Kohana/ORM.php(1001): Kohana_ORM->_load_result(true)
#3 /home/www/kohana/application/classes/Model/Order.php(19): Kohana_ORM->find_all()
#4 /home/www/kohana/application/classes/Model/Order.php(28): Model_Order->get_rows('4')
...
#11 /home/www/kohana/index.php(118): Kohana_Request->execute()
#12 {main} in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:20:59 --- EMERGENCY: Database_Exception [ 1064 ]: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '' at line 1 [ SELECT `order`.`id` AS `id`, `order`.`site_id` AS `site_id`, `order`.`type` AS `type`, `order`.`content` AS `content`, `order`.`user_id` AS `user_id`, `order`.`date` AS `date`, `order`.`user_ref` AS `user_ref`, `order`.`enter_page` AS `enter_page`, `order`.`send_page` AS `send_page`, `order`.`engine` AS `engine`, `order`.`utm_type` AS `utm_type`, `order`.`adv_comp` AS `adv_comp`, `order`.`keywords` AS `keywords`, `order`.`webvisor_link` AS `webvisor_link`, `order`.`add_info` AS `add_info` FROM `orders` AS `order` WHERE `site_id` = '16' ORDER BY `id` = ] ~ MODPATH/database/classes/Kohana/Database/MySQL.php [ 194 ] in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:20:59 --- DEBUG: #0 /home/www/kohana/modules/database/classes/Kohana/Database/Query.php(251): Kohana_Database_MySQL->query(1, 'SELECT `order`....', 'Model_Order', Array)
#1 /home/www/kohana/modules/orm/classes/Kohana/ORM.php(1060): Kohana_Database_Query->execute(Object(Database_MySQL))
#2 /home/www/kohana/modules/orm/classes/Kohana/ORM.php(1001): Kohana_ORM->_load_result(true)
#3 /home/www/kohana/application/classes/Model/Order.php(19): Kohana_ORM->find_all()
#4 /home/www/kohana/application/classes/Model/Order.php(28): Model_Order->get_rows('16')
#5 /home/www/kohana/application/classes/Controller/Index.php(42): Model_Order->get_results('16')
#6 /home/www/kohana/system/classes/Kohana/Controller.php(84): Controller_Index->action_results()
#7 [internal function]: Kohana_Controller->execute()
#8 /home/www/kohana/system/classes/Kohana/Request/Client/Internal.php(97): ReflectionMethod->invoke(Object(Controller_Index))
#9 /home/www/kohana/system/classes/Kohana/Request/Client.php(114): Kohana_Request_Client_Internal->execute_request(Object(Request), Object(Response))
...
#11 /home/www/kohana/index.php(118): Kohana_Request->execute()
#12 {main} in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:21:00 --- EMERGENCY: Database_Exception [ 1064 ]: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '' at line 1 [ SELECT `order`.`id` AS `id`, `order`.`site_id` AS `site_id`, `order`.`type` AS `type`, `order`.`content` AS `content`, `order`.`user_id` AS `user_id`, `order`.`date` AS `date`, `order`.`user_ref` AS `user_ref`, `order`.`enter_page` AS `enter_page`, `order`.`send_page` AS `send_page`, `order`.`engine` AS `engine`, `order`.`utm_type` AS `utm_type`, `order`.`adv_comp` AS `adv_comp`, `order`.`keywords` AS `keywords`, `order`.`webvisor_link` AS `webvisor_link`, `order`.`add_info` AS `add_info` FROM `orders` AS `order` WHERE `site_id` = '4' ORDER BY `id` = ] ~ MODPATH/database/classes/Kohana/Database/MySQL.php [ 194 ] in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:21:00 --- DEBUG: #0 /home/www/kohana/modules/database/classes/Kohana/Database/Query.php(251): Kohana_Database_MySQL->query(1, 'SELECT `order`....', 'Model_Order', Array)
#1 /home/www/kohana/modules/orm/classes/Kohana/ORM.php(1060): Kohana_Database_Query->execute(Object(Database_MySQL))
#2 /home/www/kohana/modules/orm/classes/Kohana/ORM.php(1001): Kohana_ORM->_load_result(true)
#3 /home/www/kohana/application/classes/Model/Order.php(19): Kohana_ORM->find_all()
#4 /home/www/kohana/application/classes/Model/Order.php(28): Model_Order->get_rows('4')
...
#11 /home/www/kohana/index.php(118): Kohana_Request->execute()
#12 {main} in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:21:02 --- EMERGENCY: Database_Exception [ 1064 ]: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '' at line 1 [ SELECT `order`.`id` AS `id`, `order`.`site_id` AS `site_id`, `order`.`type` AS `type`, `order`.`content` AS `content`, `order`.`user_id` AS `user_id`, `order`.`date` AS `date`, `order`.`user_ref` AS `user_ref`, `order`.`enter_page` AS `enter_page`, `order`.`send_page` AS `send_page`, `order`.`engine` AS `engine`, `order`.`utm_type` AS `utm_type`, `order`.`adv_comp` AS `adv_comp`, `order`.`keywords` AS `keywords`, `order`.`webvisor_link` AS `webvisor_link`, `order`.`add_info` AS `add_info` FROM `orders` AS `order` WHERE `site_id` = '16' ORDER BY `id` = ] ~ MODPATH/database/classes/Kohana/Database/MySQL.php [ 194 ] in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:21:02 --- DEBUG: #0 /home/www/kohana/modules/database/classes/Kohana/Database/Query.php(251): Kohana_Database_MySQL->query(1, 'SELECT `order`....', 'Model_Order', Array)
#1 /home/www/kohana/modules/orm/classes/Kohana/ORM.php(1060): Kohana_Database_Query->execute(Object(Database_MySQL))
#2 /home/www/kohana/modules/orm/classes/Kohana/ORM.php(1001): Kohana_ORM->_load_result(true)
#3 /home/www/kohana/application/classes/Model/Order.php(19): Kohana_ORM->find_all()
#4 /home/www/kohana/application/classes/Model/Order.php(28): Model_Order->get_rows('16')
...
#11 /home/www/kohana/index.php(118): Kohana_Request->execute()
#12 {main} in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:21:07 --- EMERGENCY: Database_Exception [ 1064 ]: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '' at line 1 [ SELECT `order`.`id` AS `id`, `order`.`site_id` AS `site_id`, `order`.`type` AS `type`, `order`.`content` AS `content`, `order`.`user_id` AS `user_id`, `order`.`date` AS `date`, `order`.`user_ref` AS `user_ref`, `order`.`enter_page` AS `enter_page`, `order`.`send_page` AS `send_page`, `order`.`engine` AS `engine`, `order`.`utm_type` AS `utm_type`, `order`.`adv_comp` AS `adv_comp`, `order`.`keywords` AS `keywords`, `order`.`webvisor_link` AS `webvisor_link`, `order`.`add_info` AS `add_info` FROM `orders` AS `order` WHERE `site_id` = '15' ORDER BY `id` = ] ~ MODPATH/database/classes/Kohana/Database/MySQL.php [ 194 ] in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:21:07 --- DEBUG: #0 /home/www/kohana/modules/database/classes/Kohana/Database/Query.php(251): Kohana_Database_MySQL->query(1, 'SELECT `order`....', 'Model_Order', Array)
#1 /home/www/kohana/modules/orm/classes/Kohana/ORM.php(1060): Kohana_Database_Query->execute(Object(Database_MySQL))
#2 /home/www/kohana/modules/orm/classes/Kohana/ORM.php(1001): Kohana_ORM->_load_result(true)
#3 /home/www/kohana/application/classes/Model/Order.php(19): Kohana_ORM->find_all()
#4 /home/www/kohana/application/classes/Model/Order.php(28): Model_Order->get_rows('15')
#5 /home/www/kohana/application/classes/Controller/Index.php(42): Model_Order->get_results('15')
#6 /home/www/kohana/system/classes/Kohana/Controller.php(84): Controller_Index->action_results()
#7 [internal function]: Kohana_Controller->execute()
#8 /home/www/kohana/system/classes/Kohana/Request/Client/Internal.php(97): ReflectionMethod->invoke(Object(Controller_Index))
#9 /home/www/kohana/system/classes/Kohana/Request/Client.php(114): Kohana_Request_Client_Internal->execute_request(Object(Request), Object(Response))
...
#11 /home/www/kohana/index.php(118): Kohana_Request->execute()
#12 {main} in /home/www/kohana/modules/database/classes/Kohana/Database/Query.php:251
2013-05-15 10:26:50 --- EMERGENCY: ErrorException [ 8 ]: Undefined variable: item ~ APPPATH/classes/Model/Order.php [ 28 ] in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:26:50 --- DEBUG: #0 /home/www/kohana/application/classes/Model/Order.php(28): Kohana_Core::error_handler(8, 'Undefined varia...', '/home/www/kohan...', 28, Array)
#1 /home/www/kohana/application/classes/Controller/Index.php(42): Model_Order->get_results('18')
#2 /home/www/kohana/system/classes/Kohana/Controller.php(84): Controller_Index->action_results()
#3 [internal function]: Kohana_Controller->execute()
#4 /home/www/kohana/system/classes/Kohana/Request/Client/Internal.php(97): ReflectionMethod->invoke(Object(Controller_Index))
#5 /home/www/kohana/system/classes/Kohana/Request/Client.php(114): Kohana_Request_Client_Internal->execute_request(Object(Request), Object(Response))
#6 /home/www/kohana/system/classes/Kohana/Request.php(990): Kohana_Request_Client->execute(Object(Request))
#7 /home/www/kohana/index.php(118): Kohana_Request->execute()
#8 {main} in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:26:52 --- EMERGENCY: ErrorException [ 8 ]: Undefined variable: item ~ APPPATH/classes/Model/Order.php [ 28 ] in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:26:52 --- DEBUG: #0 /home/www/kohana/application/classes/Model/Order.php(28): Kohana_Core::error_handler(8, 'Undefined varia...', '/home/www/kohan...', 28, Array)
#1 /home/www/kohana/application/classes/Controller/Index.php(42): Model_Order->get_results('5')
#2 /home/www/kohana/system/classes/Kohana/Controller.php(84): Controller_Index->action_results()
#3 [internal function]: Kohana_Controller->execute()
#4 /home/www/kohana/system/classes/Kohana/Request/Client/Internal.php(97): ReflectionMethod->invoke(Object(Controller_Index))
#5 /home/www/kohana/system/classes/Kohana/Request/Client.php(114): Kohana_Request_Client_Internal->execute_request(Object(Request), Object(Response))
...
#7 /home/www/kohana/index.php(118): Kohana_Request->execute()
#8 {main} in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:26:56 --- EMERGENCY: ErrorException [ 8 ]: Undefined variable: item ~ APPPATH/classes/Model/Order.php [ 28 ] in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:26:56 --- DEBUG: #0 /home/www/kohana/application/classes/Model/Order.php(28): Kohana_Core::error_handler(8, 'Undefined varia...', '/home/www/kohan...', 28, Array)
#1 /home/www/kohana/application/classes/Controller/Index.php(42): Model_Order->get_results('18')
#2 /home/www/kohana/system/classes/Kohana/Controller.php(84): Controller_Index->action_results()
#3 [internal function]: Kohana_Controller->execute()
#4 /home/www/kohana/system/classes/Kohana/Request/Client/Internal.php(97): ReflectionMethod->invoke(Object(Controller_Index))
...
#7 /home/www/kohana/index.php(118): Kohana_Request->execute()
#8 {main} in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:27:02 --- EMERGENCY: ErrorException [ 8 ]: Undefined variable: item ~ APPPATH/classes/Model/Order.php [ 28 ] in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:27:02 --- DEBUG: #0 /home/www/kohana/application/classes/Model/Order.php(28): Kohana_Core::error_handler(8, 'Undefined varia...', '/home/www/kohan...', 28, Array)
#1 /home/www/kohana/application/classes/Controller/Index.php(42): Model_Order->get_results('16')
#2 /home/www/kohana/system/classes/Kohana/Controller.php(84): Controller_Index->action_results()
#3 [internal function]: Kohana_Controller->execute()
#4 /home/www/kohana/system/classes/Kohana/Request/Client/Internal.php(97): ReflectionMethod->invoke(Object(Controller_Index))
#5 /home/www/kohana/system/classes/Kohana/Request/Client.php(114): Kohana_Request_Client_Internal->execute_request(Object(Request), Object(Response))
...
#7 /home/www/kohana/index.php(118): Kohana_Request->execute()
#8 {main} in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:27:04 --- EMERGENCY: ErrorException [ 8 ]: Undefined variable: item ~ APPPATH/classes/Model/Order.php [ 28 ] in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:27:04 --- DEBUG: #0 /home/www/kohana/application/classes/Model/Order.php(28): Kohana_Core::error_handler(8, 'Undefined varia...', '/home/www/kohan...', 28, Array)
#1 /home/www/kohana/application/classes/Controller/Index.php(42): Model_Order->get_results('4')
#2 /home/www/kohana/system/classes/Kohana/Controller.php(84): Controller_Index->action_results()
#3 [internal function]: Kohana_Controller->execute()
#4 /home/www/kohana/system/classes/Kohana/Request/Client/Internal.php(97): ReflectionMethod->invoke(Object(Controller_Index))
...
#7 /home/www/kohana/index.php(118): Kohana_Request->execute()
#8 {main} in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:27:06 --- EMERGENCY: ErrorException [ 8 ]: Undefined variable: item ~ APPPATH/classes/Model/Order.php [ 28 ] in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:27:06 --- DEBUG: #0 /home/www/kohana/application/classes/Model/Order.php(28): Kohana_Core::error_handler(8, 'Undefined varia...', '/home/www/kohan...', 28, Array)
#1 /home/www/kohana/application/classes/Controller/Index.php(42): Model_Order->get_results('5')
#2 /home/www/kohana/system/classes/Kohana/Controller.php(84): Controller_Index->action_results()
#3 [internal function]: Kohana_Controller->execute()
#4 /home/www/kohana/system/classes/Kohana/Request/Client/Internal.php(97): ReflectionMethod->invoke(Object(Controller_Index))
...
#7 /home/www/kohana/index.php(118): Kohana_Request->execute()
#8 {main} in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:27:08 --- EMERGENCY: ErrorException [ 8 ]: Undefined variable: item ~ APPPATH/classes/Model/Order.php [ 28 ] in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:27:08 --- DEBUG: #0 /home/www/kohana/application/classes/Model/Order.php(28): Kohana_Core::error_handler(8, 'Undefined varia...', '/home/www/kohan...', 28, Array)
#1 /home/www/kohana/application/classes/Controller/Index.php(42): Model_Order->get_results('16')
#2 /home/www/kohana/system/classes/Kohana/Controller.php(84): Controller_Index->action_results()
#3 [internal function]: Kohana_Controller->execute()
#4 /home/www/kohana/system/classes/Kohana/Request/Client/Internal.php(97): ReflectionMethod->invoke(Object(Controller_Index))
...
#7 /home/www/kohana/index.php(118): Kohana_Request->execute()
#8 {main} in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:27:09 --- EMERGENCY: ErrorException [ 8 ]: Undefined variable: item ~ APPPATH/classes/Model/Order.php [ 28 ] in /home/www/kohana/application/classes/Model/Order.php:28
2013-05-15 10:27:09 --- DEBUG: #0 /home/www/kohana/application/classes/Model/Order.php(28): Kohana_Core::error_handler(8, 'Undefined varia...', '/home/www/kohan...', 28, Array)
#1 /home/www/kohana/application/classes/Controller/Index.php(42): Model_Order->get_results('15')
#2 /home/www/kohana/system/classes/Kohana/Controller.php(84): Controller_Index->action_results()
#3 [internal function]: Kohana_Controller->execute()
#4 /home/www/kohana/system/classes/Kohana/Request/Client/Internal.php(97): ReflectionMethod->invoke(Object(Controller_Index))
#5 /home/www/kohana/system/classes/Kohana/Request/Client.php(114): Kohana_Request_Client_Internal->execute_request(Object(Request), Object(Response))
